...
## 4.
```{r echo=F, fig.show="hold", out.width ='.49\\linewidth', fig.align="center"}
...
\end{center}
```{r echo=F, fig.show="hold", out.width ='.49\\linewidth', fig.align="center"}
knitr::include_graphics("figure/acc_l.png")
knitr::include_graphics("figure/acc_q.png")
```
...
\end{center}
```{r echo=F, fig.show="hold", out.width ='.49\\linewidth', fig.align="center"}
knitr::include_graphics("figure/male_l.png")
knitr::include_graphics("figure/male_q.png")
```
...
\end{center}
```{r echo=F, fig.show="hold", out.width ='.49\\linewidth', fig.align="center"}
knitr::include_graphics("figure/age_l.png")
knitr::include_graphics("figure/age_q.png")
```
...
\end{center}
```{r echo=F, fig.show="hold", out.width ='.49\\linewidth', fig.align="center"}
knitr::include_graphics("figure/white_l.png")
knitr::include_graphics("figure/white_q.png")
```
...
## 8.
```{r echo=F, fig.show="hold", out.width ='.49\\linewidth', fig.align="center"}
knitr::include_graphics("figure/recid_l.png")
knitr::include_graphics("figure/recid_q.png")
```
